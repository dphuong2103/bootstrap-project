...
public enum ErrorCode {
    ...
    TODO_NOT_FOUND("TODO_NOT_FOUND","Todo not found","Không tìm thấy todo", HttpStatus.NOT_FOUND),
    TODO_NAME_EMPTY("TODO_NAME_EMPTY","Name is invalid","Name lỗi", HttpStatus.BAD_REQUEST),
    ;
